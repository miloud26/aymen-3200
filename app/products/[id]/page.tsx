...
export default function Page({ params }: ProductType) {
  ...
  const handleSubmitOrder = async (e: any) => {
    ...
    try {
      ...
      data.append("prix", quantity == 1 ? "3700" : "6000");
      ...
      <Box className=" flex w-fit justify-center items-start px-5 md:px-14  lg:px-[200px] gap-5 flex-wrap lg:flex-nowrap">
        ...
        <Box className=" w-full lg:w-[48%] ">
          ...
          <Box>
            ...
            <Box className="w-full flex justify-center items-center bg-red-600 text-white p-4">
              <Typography
                sx={{
                  fontSize: "33px",
                  textAlign: "center",
              ...
              >
                يرجى فتح الطرد قبل الدفع و تفقد الطرد جيدا و يرجى اخبارنا باي
                مشكل
              </Typography>
            </Box>
